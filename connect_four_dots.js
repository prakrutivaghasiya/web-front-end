 var player1 = prompt("Player 1 : Enter your name.  You will be Purple!");
 var player1Color = 'rgb(86, 151, 255)';

 var player2 = prompt("Player 2 : Enter your name.  You will be Orange!");
 ...
 $('h3').text(player1+ ": It is your turn. Please pick a column to drop your Purple chip!!");
 ...
 $('.board button').on('click',function() {
   ...
   if (horizontalWinCheck() || verticalWinCheck() || diaganolWinCheck()){
     gameEnd(currentName);
   }
